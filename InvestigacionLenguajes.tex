...
Lenguaje Orientado a Objetos, multiparadigma, estructurado, dirigido por eventos y funcional.

\paragraph{ }
Diseñado por Anders Hejlsberg

\section{Características}

 \begin{enumerate}
 \item Lenguaje de programación orientado a objetos simple, moderno y de propósito general.
 \item Incluye principios de Ingenieria de Software como:
	\begin{enumerate}
	 ...
	 \end{enumerate}
\item Capacidad de desarrollo de componentes para ambientes distribuidos.
